...
network["device"] = np.array([
    ...
    [1, 2, -1, 0.2, 0, -30, None, None, None, None, None, None, None, None, None],
    [2, 2, 2, None, 50, 0, 50, -50, 35, None, 20, -20, None, None, None],
    [3, 3, -1, 0.2, 0, -30, None, None, None, None, None, None, None, None, None],
    [4, 3, 3, None, 50, -50, 50, -50, 30, -30, 25, -25, 100, 0, 0.9]
])

network["branch"] = np.array([
    [0, 1, 0.0036, 0.1834, 0., 32, 1, 0],
    [1, 2, 0.0303, 0.0611, 0., 18, 1, 0],
    [1, 3, 0.0159, 0.0502, 0., 18, 1, 0]
])
